...
namespace Core.DataAccess
{
    public class Databasefeeder
    {
        ...
        public Databasefeeder()
        {
            ...
            {
                Countries = [
                    new() { Id = 2, Name = "England", Position = 1 },
                    new() { Id = 3, Name = "Spain", Position = 2 },
                    new() { Id = 2, Name = "Germany", Position = 3 },
                    new() { Id = 2, Name = "Italy", Position = 4 },
                    new() { Id = 2, Name = "France", Position = 5 },
                    new() { Id = 2, Name = "Portugal", Position = 6 },
                    new() { Id = 2, Name = "Netherlands", Position = 7 },
                    new() { Id = 2, Name = "Belgium", Position = 8 },
                    new() { Id = 2, Name = "Turkey", Position = 9 },
                    new() { Id = 2, Name = "Czech", Position = 10 },
                    new() { Id = 1, Name = "Greece", Position = 11 }];
